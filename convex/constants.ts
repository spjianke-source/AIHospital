...
export const CONVERSATION_DISTANCE = 1.5;
...
// Don't talk to anyone for 7.5s after having a conversation.
export const CONVERSATION_COOLDOWN = 7500;

// Don't do another activity for 5s after doing one.
export const ACTIVITY_COOLDOWN = 5000;

// Don't talk to a player within 30s of talking to them.
...
export const AWKWARD_CONVERSATION_TIMEOUT = 30_000; // more time locally
// export const AWKWARD_CONVERSATION_TIMEOUT = 20_000;

// Leave a conversation after participating too long.
export const MAX_CONVERSATION_DURATION = 5 * 60_000; // more time locally
...
export const ACTIVITIES: { description: string; emoji: string; duration: number }[] = [];
